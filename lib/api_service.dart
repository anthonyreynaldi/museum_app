...
class ApiService {
  ...
  static getToken() async {
    ...
    jwt = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOi8vMTI3LjAuMC4xOjgwMDAvYXBpL2F1dGgvbG9naW4iLCJpYXQiOjE2ODc0NDY0NzIsImV4cCI6MTY4NzUzMjg3MiwibmJmIjoxNjg3NDQ2NDcyLCJqdGkiOiI5YnloZVFHb0hkOE9HcDhVIiwic3ViIjoiMSIsInBydiI6IjIzYmQ1Yzg5NDlmNjAwYWRiMzllNzAxYzQwMDg3MmRiN2E1OTc2ZjcifQ.J7206DHXLBOS-zLJZXdCbj3xIZV7kLMlnMiMP6ahLHE";
  ...
  static Future<List<Comment>> getComments(museumId) async {
    ...
    final response = await http.get(Uri.parse('$baseUrl/api/comments/$museumId'), headers: header);
    if (response.statusCode == 200) {
      final List<dynamic> jsonData = json.decode(response.body);
      print(jsonData);
  ...
  static postComments(museumId, komentar) async {
    ...
    final response = await http.post(Uri.parse('$baseUrl/api/comment'), headers: header, body: body);
